...
const handleWalletTransfer = () => {
    router.push({name: "WalletTransfer"})
}
                ...
                <el-col :span="22">
                    <el-form ref="transferFormRef" :model="transferForm" class="login-form"
                        ...
                        <el-form-item prop="hash_id">
                            <el-input v-model="transferForm.to_wallet_id" size="large" placeholder="Wallet Address"
                                      tabIndex="-1">
                            </el-input>
                            ...
                            >
                                <el-option v-for="item in addressList" :key="item.id"
                                           ...
                                           :value="item.address">
                                    <span style="float: left;margin-right:10px;">{{ item.remark }}</span>
                                    <span
                        ...
                        <el-form-item prop="name">
                            <el-select v-model="transferForm.from_wallet_id" size="large" placeholder="Select Currency"
                                       filterable
                                       clearable>
                                <el-option
                        ...
                        <el-form-item>
                            <van-button round block native-type="submit" @click.native.prevent="handleWalletTransfer">
                                Wallet Transfer
                            </van-button>
                        </el-form-item>
                    </el-form>
