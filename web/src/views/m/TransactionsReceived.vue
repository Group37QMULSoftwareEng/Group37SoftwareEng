...
const getDataList = () => {
    queryInfo.value.to_user_id = store.state.user.id;
            ...
            <template #header>
                <div class="card-header">
                    <div class="wallet-name-avatar">
                        <div class="avatar">
                            <el-avatar :size="50" :src="item.from_avatar"></el-avatar>
                        </div>
                        <div class="wallet-name-balance">
                            <div class="wallet-name">
                                Receive from {{ item.from_username }}
                            </div>
                            <div class="balance">
                                {{ item.amount }} {{ item.to_currency_name }}
                            </div>
                        </div>
                    </div>
