    ...
    <el-container class="el-container-fix">
        <el-header>
            <el-row :gutter="20">
                ...
                <el-col :span="4">
                    <el-select v-model="queryInfo.state" placeholder="User state">
                        <el-option :value="0" label="Locked"></el-option>
        ...
        <el-form :model="addForm">
            ...
            <el-form-item prop="role">
                <el-select v-model="addForm.role" placeholder="Role">
                    ...
                    <el-option label="Service" :value="2"></el-option>
                </el-select>
            </el-form-item>
