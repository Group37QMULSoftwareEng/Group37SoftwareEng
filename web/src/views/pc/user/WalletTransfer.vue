...
<template>
  <el-container>
    <el-main>
      ...
      <el-row type="flex" justify="center" :gutter="20" class="el-row-margin">
        <el-col :span="4">
          <label>Amount</label>
        ...
        <el-col :span="4">
          ...
          <el-select v-model="from_wallet_id" placeholder="Select Currency" filterable clearable
                     style="width: 240px">
            <el-option
        ...
        <el-col :span="4">
          <label>To</label>
          <el-select v-model="to_wallet_id" placeholder="Select Currency" filterable clearable
                     style="width: 240px">
            <el-option
                v-for="row in wallets"
                :key="row.id"
      ...
      <el-row type="flex" justify="center" class="el-row-top">
        <el-button type="primary" class="submit-btn"
                   ...
                   @keyup.enter.prevent="handleWalletTransfer">
          Transfer
        </el-button>
      </el-row>
    </el-main>
